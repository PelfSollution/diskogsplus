    ...
    if (req.method === 'GET') {
        ...
        try {
            ...
            if (tokenResponse.status !== 200) {
                throw new Error(tokenResult.error_description || 'Error obteniendo el token de acceso de Spotify');
            }
            ...
            setCookie('spotifyRefreshToken', tokenResult.refresh_token, cookieOptions);

            // Redirige al usuario a donde quieras después de la autenticación exitosa, por ejemplo, a su perfil o a la página principal.
